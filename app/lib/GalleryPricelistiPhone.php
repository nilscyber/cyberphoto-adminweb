...
?>
	...
	<tr>
	    <td colspan="4" height="2"><img border="0" src="/pic/galleryline_iphone.jpg" width="600" height="2"></td>
  	</tr>
	...
	<?php
	 if ($article->no_buy == 0) {
		...
		elseif ($article->lagersaldo <= 0 && $article->bestallningsgrans > 0) {
			print "<A HREF=\"javascript:modifyItems('$article->artnr')\">";
			print "<IMG ALT=\"Varan är beställd\" SRC=\"/pic/66.gif\" border=0>";
			print "</A>";
			}
		elseif ($article->lagersaldo <= 0 && $article->bestallningsgrans == 0) {
			print "<A HREF=\"javascript:modifyItems('$article->artnr')\">";
			print "<IMG ALT=\"Beställningsvara\" SRC=\"/pic/99.gif\" border=0>";
			print "</A>";
			}
	}
	else
	...
	?>
	  ...
	  <?php if ($article->kategori_id == 336) { ?>
	  <tr>
	    <td colspan="2" align="center">
	  ...
	  <?php } ?>
	  <?php if ($article->abb_data == -1) { ?>
	  <tr>
	    <td colspan="2" align="center">
	    <a href="info.php?article=<?php echo $article->artnr; ?>#bookmark">
	    <font color="#000000" size=1 face="Verdana, Arial"><b>Från <font color="#85000D" size=1 face="Verdana, Arial"><?php echo $mobile->displayLowestPrice($article->artnr,2); ?> kr</font> med mobilt bredband</font>
	    </a>
	    </td>
	  </tr>
	  <?php } ?>
