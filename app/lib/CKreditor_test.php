...
Class CKreditor {
	...
	function reserve_amount() {
		global $goodsvalueMoms, $pay, $KRED_SEND_BE_EMAIL, $KRED_FI_PNO, $KRED_ISO639_SV, $KRED_SE_PNO, $KRED_ISO3166_SE, $KRED_ISO3166_FI; 
		...
		echo "här är det: " . $_SESSION['old_telnr'] . ", " . $_SESSION['old_mobilnr'];
		...
		// flags
		if ( (     ereg("^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,5})$", $_SESSION['old_email'] ))) 
	...
	function get_address($pno) {
		global $eid, $secret;
		$status = get_addresses($pno, $eid, $secret, 2, $result);
		if ($status == 0) {
	...
	function print_addresses() {
		...
		$ret =  "<input type='text' name='lastName' size='24' value='" . $this->cust_addresses[0][0] . "' onFocus='this.blur()' style='font-family: Verdana; font-size: 8pt; background-color: #EBEBEB'><br>";
		$ret .=  "<input type='text' name='adress' size='24' value='" . $this->cust_addresses[0][1] . "' onFocus='this.blur()' style='font-family: Verdana; font-size: 8pt; background-color: #EBEBEB'><br>";
		$ret .=  "<input type='text' name='postnummer' size='5' value='" . $this->cust_addresses[0][2] . "' onFocus='this.blur()' style='font-family: Verdana; font-size: 8pt; background-color: #EBEBEB'> ";
		$ret .=  "<input type='text' name='ort' size='16' value='" . $this->cust_addresses[0][3] . "' onFocus='this.blur()' style='font-family: Verdana; font-size: 8pt; background-color: #EBEBEB'>";
		echo $ret;
		//return $ret;
	}
	/**
