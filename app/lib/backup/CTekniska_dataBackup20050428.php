...
function show_digikam($tekniska_data, $extra_articles) {
	...
	$select .= "WHERE Artiklar.kategori_id = 6 && ej_med=0 AND (utgangen=0 OR lagersaldo > 0) && ((artnr not like '%pac') )";
...
function show_screenTV($tekniska_data, $extra_articles) {
	...
	$select  = "SELECT artnr, beskrivning, tillverkare, ej_med, link FROM Artiklar ";
	$select .= "LEFT JOIN Tillverkare ON Artiklar.tillverkar_id=Tillverkare.tillverkar_id ";
	$select .= "WHERE Artiklar.kategori_id = 328 && ej_med = 0 AND (utgangen=0 OR lagersaldo > 0) AND (artnr not like '%pac') ";
	$select .= "order by tillverkare ASC, beskrivning ASC ";
...
function show_screen($tekniska_data, $extra_articles) {
	...
	$select  = "SELECT artnr, beskrivning, tillverkare, ej_med, link FROM Artiklar ";
	$select .= "LEFT JOIN Tillverkare ON Artiklar.tillverkar_id=Tillverkare.tillverkar_id ";
	$select .= "WHERE Artiklar.kategori_id = 327 && ej_med = '0' AND (utgangen=0 OR lagersaldo > 0) && (artnr not like '%pac') ";
	$select .= "order by tillverkare ASC, beskrivning ASC ";
...
function show_mp3($tekniska_data, $extra_articles) {
	...
	$select  = "SELECT artnr, beskrivning, tillverkare, ej_med, link FROM Artiklar ";
	$select .= "LEFT JOIN Tillverkare ON Artiklar.tillverkar_id=Tillverkare.tillverkar_id ";
	$select .= "WHERE Artiklar.kategori_id = 127 && ej_med = 0 AND (utgangen=0 OR lagersaldo > 0) && (artnr not like '%pac') ";
	$select .= "order by tillverkare ASC, beskrivning ASC ";
...
function show_comp($tekniska_data, $extra_articles, $kategorier, $kat) {
	...
	$select  = "SELECT artnr, beskrivning, tillverkare, ej_med, link FROM Artiklar ";
	$select .= "LEFT JOIN Tillverkare ON Artiklar.tillverkar_id=Tillverkare.tillverkar_id ";
	$select .= "WHERE " . $kategorier . " && ej_med = 0 AND (utgangen=0 OR lagersaldo > 0) AND (artnr not like '%pac') ";
	$select .= "order by tillverkare ASC, beskrivning ASC ";
