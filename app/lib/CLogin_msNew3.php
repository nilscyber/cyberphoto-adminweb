...
"old_nyhetsbrev", "CcName", "old_avtalskund", "old_mobilnr", "old_sms", "old_nyhetsbrev");
...
function customer_info() {
	...
	*/
	...
	$old_foretag, $old_userName, $old_avtalskund, $old_mobilnr, $old_sms, $old_nyhetsbrev;
	...
	if ($confirm == '1') {
		...
		$select .= "savelogin, land_fi, foretag, userName, avtalskund, mobilnr, sms ";
