...
<% } %>
<td align="left" valign="bottom"><font face="Verdana, Arial" size="1"><b><% if ($sv): %><b>Innermått&nbsp;(L&nbsp;x&nbsp;B&nbsp;x&nbsp;H)</b><% else: %><b>Sisämitta&nbsp;(L&nbsp;x&nbsp;B&nbsp;x&nbsp;H)</b><% endif; %></b></font></td>
...
<% } else { %>
<td align="right" valign="bottom"><font face="Verdana, Arial" size="1"><b><% if ($sv): %>Pris&nbsp;med&nbsp;moms<% else: %>Hinta&nbsp;alv&nbsp;23%<% endif; %></b></font></td>
<% } %>
