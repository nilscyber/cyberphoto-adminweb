...
<div class="content22">
  ...
  <table border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter1 == "yes") { ?><b><font color="#000000"><?php } ?><?php if ($sv): ?>Nybörjare<?php else: ?>Aloittelia<?php endif; ?></font></b></td>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter2 == "yes") { ?><b><font color="#000000"><?php } ?><?php if ($sv): ?>Avancerad<?php else: ?>Edistynyt<?php endif; ?></font></b></td>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter3 == "yes") { ?><b><font color="#000000"><?php } ?><?php if ($sv): ?>Professionell<?php else: ?>Ammattilainen<?php endif; ?></font></b></td>
    </tr>
  </table>
