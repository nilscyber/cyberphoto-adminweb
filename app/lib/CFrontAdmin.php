...
function __construct() {
	...
	$this->conn_my2 = Db::getConnectionDb('prestashop14');
...
if ($site == 2) {
	...
	if ($frontSection == 1) {
		$select .= "AND frontPicture LIKE 'fi_mob_last_large_%' ";
	} elseif ($frontSection == 2 || $frontSection == 7) {
		$select .= "AND frontPicture LIKE 'fi_mob_last_mh_%' ";
	} elseif ($frontSection == 5 || $frontSection == 6) {
		$select .= "AND frontPicture LIKE 'fi_mob_last_mv_%' ";
	} elseif ($frontSection > 100) {
		$select .= "AND frontPicture LIKE 'fi_mob_last_right_%' ";
	} else {
		$select .= "AND frontPicture LIKE 'fi_mob_last_small_%' ";
	}
} elseif ($site == 8) {
	if ($frontSection == 1) {
		$select .= "AND frontPicture LIKE 'fi_sv_mob_last_large_%' ";
	} elseif ($frontSection == 2 || $frontSection == 7) {
		$select .= "AND frontPicture LIKE 'fi_sv_mob_last_mh_%' ";
	} elseif ($frontSection == 5 || $frontSection == 6) {
		$select .= "AND frontPicture LIKE 'fi_sv_mob_last_mv_%' ";
	} elseif ($frontSection > 100) {
		$select .= "AND frontPicture LIKE 'fi_sv_mob_last_right_%' ";
	} else {
		$select .= "AND frontPicture LIKE 'fi_sv_mob_last_small_%' ";
	}
} else {
	if ($frontSection == 1) {
	...
	if (mysqli_num_rows($res) > 0) {
		...
		if ($frontLinc != "") {
			...
			if ($site == 2 || $site == 7) {
				...
				echo "<a href=\"/info.php?article=$frontArtNr\">";
...
function mostSoldMobilNew2($kategorier_id, $limit, $sv, $fi) {
	...
	$countrow = 0;
        ...
        $select  = "SELECT mostSoldArticles.artnr, mostSoldArticles.antalManad1, Artiklar.link, Artiklar.beskrivning, Artiklar.kortinfo, Artiklar.bild, Artiklar.lagersaldo, Artiklar.bestallningsgrans, Artiklar.utpris, Tillverkare.tillverkare, ";
        $select .= "Artiklar_fi.beskrivning_fi, Artiklar_fi.link2_fi, Artiklar_fi.utpris_fi, Moms.momssats, Moms.momssats_fi ";
        $select .= "FROM Artiklar ";
