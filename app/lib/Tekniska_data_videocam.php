...
<tr>
	<td colspan="2" valign="top" class="tek_white_row"><a target="_blank" href="/order/admin/Tekn_video.php?change=<?php echo $tekniska_data_info; ?>"><img border="0" src="/pic/editera.gif">&nbsp;Editera Tekniska data-tabellen</a></td>
</tr>
<?php } ?>
...
<tr>
	<td valign="top"><?php echo l('System'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params1); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('CMOS size'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params2); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('CMOS gross'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params3); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Still mode'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params4); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Lens'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params5); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Optical zoom'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params6); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Digital zoom'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params7); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Image stabilization'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params8); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Minimum illumination'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params9); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Focus'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params10); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Filterdiameter'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params11); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('White balance'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params12); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Digital effects'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params13); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Exposure'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params14); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Scene modes'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params15); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Viewfinder'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params16); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Screen'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params17); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Built-in flash'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params18); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Memory card'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params19); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Built-in memory'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params20); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Speaker'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params21); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Accessory shoe'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params22); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('AV output'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params23); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('S-video output'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params24); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('LANC input'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params25); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Wi-Fi'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params26); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('HDMI output'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params27); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Microphone input'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params28); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('USB output'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params29); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Headphone output'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params30); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Remote control'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params31); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Instructions for use'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params32); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Dimensions'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params33); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Weight'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params34); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Bundled software'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params35); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Included accessories'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params36); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Additional comment'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params37); ?></td>
	<?php endfor; ?>
</tr>
...
<tr>
	...
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top" class="tek_first_row"><?php show_tek_video($tekniska_artnr[$i], 'NULL'); ?></td>
	<?php endfor; ?>
</tr>
<?php } ?>