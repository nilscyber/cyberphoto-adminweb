...
# version	2000-11-20
	...
	<?php if (count($articles) < 1) { ?>
		<td><font color="#000000" face="Verdana,Arial" size="1"><b>
	<?php } ?>
        <?php              
                             echo "$headline";
...
?>
	...
	// if ($bask->check_days_instock($article->artnr)) {
	
		$bask->display_days_instock($article->artnr);
