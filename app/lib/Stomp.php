...
class Stomp
{
    ...
    protected $_attempts = 1; // default = 10
    protected $_username = '';
    protected $_password = '';
    protected $_sessionId;
    protected $_read_timeout_seconds = 2; // default = 60
    protected $_read_timeout_milliseconds = 2000; // default = 0
    protected $_connect_timeout_seconds = 2; // default = 60
