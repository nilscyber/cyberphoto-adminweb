...
function addDiscountArticles($articles, $newordernr) {
	//id | description | discount amount | discount percent | tax code
	global $bask, $oldkommentar, $conn_standard, $fi, $sv, $goodsvalue, $moms1, $moms2, $moms3, $moms4, $rabatt;
				...
				*/
				...
				//$insert .= "values ($newordernr, '$row->artnr', $newCount, $utpris, $bokad, '$beskrivning', '$bask->ber_lev_datum', $bask->prec, '$inkommet', $momssats, $row->momskod, '$art') ";							  	  	
		  		if ($discount) {
					  ...
					  $insert  = "insert into Orderposter (ordernr, artnr, antal, utpris, bokad, beskrivning, lastDeliveryDate, prec, levDatumDatumInlagt, momssats, momskod, utprisNormal) ";
					  $insert .= "values ($newordernr, '$artnr', $count, $utpris, $bokad, '$beskrivning $extraBeskrivningText', '$bask->ber_lev_datum', $bask->prec, '$inkommet', $row->momssats, $row->momskod, $utprisNormal) ";
				}
