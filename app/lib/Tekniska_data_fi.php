...
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Anger den filtyp som bilderna sparas i. JPG är vanligast. RAW och TIFF är okomprimerade format. DNG är på kommande. Det är Adobes öppna RAW-format.')"><font face="Verdana, Arial" size="1"> Tiedostomuoto </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->kompression); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges vilken brännvidd objektivet har och ofta även vad objektivet motsvarar på en 35mm kamera.')"><font face="Verdana, Arial" size="1"> Objektiivi </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->objektiv); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges den maximala ljusstyrkan. På zoomobjektiv varierar oftast ljusstyrkan med zoomomfånget och därför anges ljusstyrkan till t ex 2,8-3,5 och där är den maximala ljusstyrkan 2,8 på vidvinkel och 3,5 på tele. Här anges inte minsta möjliga bländare.')"><font face="Verdana, Arial" size="1"> Optiikan valovoimaisuus </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->blandare); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Det verkliga zoomomfånget. Helt enkelt det omfång objektivet har.')"><font face="Verdana, Arial" size="1"> Optinen zoom </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->optisk_zoom); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Detta är egentligen ingen riktig zoom utan endast att kameran beskär i bilden. Ju mer du zoomar desto sämre upplösning.')"><font face="Verdana, Arial" size="1"> Digitaalinen zoom </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->dig_zoom); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Den storlek av filtergänga som passar kameran eller angiven filteradapter.')"><font face="Verdana, Arial" size="1"> Suodattimen halkaisija </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->filterdiam); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Om kameran har autofokus, manuell fokusering eller båda.')"><font face="Verdana, Arial" size="1"> Fokusointi </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->fokusering); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Det närmaste avstånd kameran kan ta en skarp bild.')"><font face="Verdana, Arial" size="1"> Lähietäisyys </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->nargrans); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Anger den typ av minneskort som passar kameran. Dessa hittar du under fliken tillbehör på denna sida.')"><font face="Verdana, Arial" size="1"> Muisti </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->minnestyp); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Anger det minne som ingår i standardtillbehören eller är inbyggt i kameran.')"><font face="Verdana, Arial" size="1"> Mukana tuleva muisti </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
...
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Anges idag nästan uteslutande i ISO. ISO står för International Organization for Standardization. Tidigare angavs filmkänslighet i ASA och/eller DIN. Till exempel 100ASA motsvarar 21DIN och ska nu egentligen anges ISO 100/21° men på digitalkameror så anges endast ISO 100 som motsvarande ljuskänslighet. På film ger högre ISO-tal kornigare bilder. På en digitalkamera så fungerar det likadant fast det blir inte kornigare utan brusigare bilder, ungefär samma sak.')"><font face="Verdana, Arial" size="1"> Valoherkkyys </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->ljuskanslighet); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Anger vilka tider kamerans slutare kan arbeta inom. Det vill säga den tid kamerans bildsensor/film får ljus. Vanligt är från ca 1s upp till 1/2000s.')"><font face="Verdana, Arial" size="1"> Suljinajat </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->slutartider); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges de olika exponeringslägena. Programautomatik där kameran ställer både tid och bländare. Tidsautomatik där du ställer bländaren och kameran ställer tiden. Bländarautomatik där du ställer tiden och kameran väljer bländare. Manuellt där du ställer både tid och bländare själv.')"><font face="Verdana, Arial" size="1"> Valotus </font>
	<br></a></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
...
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('En funktion där du kan påverka exponeringen utan att behöva köra manuellt. Vanligast är att du kan över eller underexponera 2 bländarsteg.')"><font face="Verdana, Arial" size="1"> Valotuksen kompensointi </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->exponeringskompensation); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Kameran kan fördröja exponeringen oftast 10-12s efter avtryck.')"><font face="Verdana, Arial" size="1"> Automaattilaukaisin </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->sjalvutlosare); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges om kameran har inbyggd blixt, och/eller om den har möjlighet till extern blixt.')"><font face="Verdana, Arial" size="1"> Salama </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->blixt); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges de inställningar som finns att ställa in på den inbyggda blixten om kameran har en sådan.')"><font face="Verdana, Arial" size="1"> Salama-asetukset
	</font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
...
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges hur långt bort du kan fotografera med den inbyggda blixten om kameran har en sådan.')"><font face="Verdana, Arial" size="1"> Salaman valaisu </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->blixt_rackvidd); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Kamerans möjlighet att ta flera bilder i en följd. Anges ofta hur många bilder per sekund (b/s alt fps) ibland även hur många bilder i följd.')"><font face="Verdana, Arial" size="1"> Sarjaotos </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info(ereg_replace('`', '"', $row[$i]->sekvenstagning)); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Om kamerans möjligheter att spela in film. Oftast anges upplösning, bilder per sekund och hur långa sekvenser som kan spelas in.')"><font face="Verdana, Arial" size="1"> Filmaus </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->film); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Anger om kameran har inbyggd mikrofon.')"><font face="Verdana, Arial" size="1"> Äänentallennus </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->ljudinspelning); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges kameran olika anslutningar. Om anslutningar sitter på en medföljande docka så anges detta.')"><font face="Verdana, Arial" size="1"> Liitännät </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana" size="1"><% show_info($row[$i]->anslutningar); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges vad kameran använder för typ av batteri.')"><font face="Verdana, Arial" size="1"> Akku </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->batteri); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Här anges speciella egenskaper eller om bruksanvisning är på annat språk än svenska.')"><font face="Verdana, Arial" size="1"> Muuta </font></a></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->ovrigt); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Kamerans mått som de uppges av tillverkaren.')"><font face="Verdana, Arial" size="1"> Mitat </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->matt); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Kamerans vikt som den uppges av tillverkaren. Tyvärr uppger de ibland med batterier och ibland utan.')"><font face="Verdana, Arial" size="1"> Paino </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->vikt); %></font></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('De tillbehör som tillverkaren uppger ska följa med.')"><font face="Verdana, Arial" size="1"> Mukana tulevat varusteet
	 </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
...
<tr>
	<td valign="top" bgcolor="#ECECE6"><a onMouseOver="return escape('Den programvara som tillverkaren uppger ska följa med.')"><font face="Verdana, Arial" size="1"> Mukana tulevat ohjelmat
	   </font></a><br></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
...
<!--
<tr>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1">Esimerkkikuvia</font></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '5') break;  %>
