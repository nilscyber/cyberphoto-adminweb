...
<tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td><span onclick="show_hide('mobilforsakring_info');" style="cursor:pointer;"><b><font face="Verdana, Arial" size="1"><?php if ($tillverkare != ".") echo $tillverkare . " "; echo $beskrivning; ?></b></(font></span></td>
        <td align="right"><span onclick="show_hide('mobilforsakring_info');" style="cursor:pointer;">(klicka här för mer info)</span></td>
      </tr>
      <tr>
        <td colspan="2"><hr noshade color="#85000D" size="1"></td>
      </tr>
      <tr>
        <!-- <td><a href="javascript:modifyItems('<?php echo $artnr2; ?>')"><img src="/pic/11.gif" border="0" title="Klicka här för att lägga till i kundvagnen"></a></td> -->
        <td><a href="/confirm_forsakring.php"><img src="/pic/11.gif" border="0" title="Klicka här för att lägga till i kundvagnen"></a></td>
