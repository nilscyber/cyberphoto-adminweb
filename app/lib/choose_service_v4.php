...
<?php } ?>
<?php if ($MF == "newsletter") { ?>
	<div class="contact_top_red"><?php echo l('Newsletter'); ?></div>
<?php } else { ?>
	<a href="#" onclick="document.lensform.MF.value='newsletter'; document.lensform.submit();">
	<div class="contact_top_white"><?php echo l('Newsletter'); ?></div></a>
<?php } ?>
<?php if ($MF == "copy") { ?>
