...
function viewItemsInBasket($firstbasket, $fi) {
	global $kundvagn, $goodsvalue, $goodsvalueMoms, $moms, $artnr, $count, $lagersaldo, $bestallt, $lev_datum, $lev_datum_normal, $bestallningsgrans, $betalsatt;
...
%>
		...
		<tr>
		  ...
		  <td bgcolor="#ECECE6" align="center"><font face="Verdana, Arial" size="1"><% echo $count; %></font></td>
...
%>	    
		<tr>
		  <td bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% echo $name . " " . $comment; %></font></td>
		  <td bgcolor="#ECECE6" align="center"><font face="Verdana, Arial" size="1">1</font></td>
		<td bgcolor="#ECECE6" align=right><font face="Verdana, Arial" size="1">
<%		printf("%10.0f SEK", $outprice);  %>
		</font></td>
		<td bgcolor="#ECECE6" align=right><font face="Verdana, Arial" size="1">
<%		printf("%10.0f SEK", $outprice + $outprice * $momsts); %>
		</font></td>
