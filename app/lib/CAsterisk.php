<?php
// I have no idea what this class should 
// be fore. It doesn't seem to be used anywhere /NK
//-------------------------------------------------------------------------------
Class CAsterisk {
	var $conn_as;
	...
	function __construct() {
		global $fi;
		$conn_as = @mssql_pconnect ("192.168.1.40", "nils", "i#$vNoNt#");
		@mssql_select_db ("", $conn_as);

		$this->conn_as = $conn_as;
		/**
		if ($fi) {
