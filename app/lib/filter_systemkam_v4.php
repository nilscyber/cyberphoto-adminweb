...
<div class="content">
  ...
  <table border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter6 == "yes") { ?><b><font color="#85000D"><?php } ?><?php if ($fi && !$sv): ?>Videokuvaus<?php else: ?>Filmfunktion<?php endif; ?></font></b></td>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter8 == "yes") { ?><b><font color="#85000D"><?php } ?><?php if ($fi && !$sv): ?>Sääsuojattu<?php else: ?>Väderskyddad<?php endif; ?></font></b></td>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter10 == "yes") { ?><b><font color="#85000D"><?php } ?><?php if ($fi && !$sv): ?>Kääntyvä näyttö<?php else: ?>Vikbar LCD-skärm<?php endif; ?></font></b></td>
    </tr>
    <tr>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter7 == "yes") { ?><b><font color="#85000D"><?php } ?><?php if ($fi && !$sv): ?>Live view<?php else: ?>Live view<?php endif; ?></font></b></td>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter9 == "yes") { ?><b><font color="#85000D"><?php } ?><?php if ($fi && !$sv): ?>Täyskenno<?php else: ?>Fullformat<?php endif; ?></font></b></td>
      ...
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter11 == "yes") { ?><b><font color="#85000D"><?php } ?><?php if ($fi && !$sv): ?>Peilitön<?php else: ?>Spegelfri<?php endif; ?></font></b></td>
    </tr>
    </table>
