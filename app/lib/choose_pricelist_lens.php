	...
	<div align="center"><center>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            ...
            <td width="25"><font size="1">&nbsp;&nbsp;|&nbsp;&nbsp;</font></td>
            <td width="80"><font size="1">Billigast först</font></td>

            <td width="20"><font size="1"><input type="checkbox" name="sortera" value="utpris" onclick="submit()"<?php if ($sortera == "utpris") echo " checked";?>></font></td>
