...
# version	2000-11-20
	...
	$current_category = "";
	print "<table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" style=\"border-left: 1px solid #EEEEEE; border-right: 1px solid #CFCFCF; border-top: 1px solid #EEEEEE; border-bottom: 1px solid #CFCFCF\" width=\"100%\">\n";
	...
	if ($article->kategori != $current_category) {
		...
		print "\t<tr>\n\t\t<td colspan=\"5\">\n";
		print "<font color=\"#000000\" face=\"Arial\" size=\"2\"><b>" . $article->kategori . "</b></font><br>";
		print "<img border=\"0\" src=\"/pic/galleryline_mobil.jpg\" width=\"600\" height=\"2\">";
		print "\t\t</td>\n</tr>\t";
	}
...
?>
	...
	<tr>
	<td align="left" width="80" height="64"><font color="#2B2B2B" size=1 face="Verdana, Arial">
	<?php
	print "<A style=\"text-decoration: none\" HREF=\"info.php?article=".$article->artnr."\">";
	?>

        <?php if ($article->bild != "") { ?>
        	<img border ="0" name="bilden" src="<?php echo "/thumbs/medium/bilder/".$article->bild; ?>"></a>
        	<?php } else { ?>
	...
	<td height="64"><font color="#2B2B2B" size="1" face="Verdana"><b>
	<?php
	print "<A style=\"text-decoration: none\" HREF=\"info.php?article=".$article->artnr."\">";
	...
	<td align="center" width="75" height="64">
	<?php
	if (eregi("REA!", $article->kommentar)) {
	...
	<td align="center" width="75" height="64"><font color="#000000" size=2 face="Verdana, Arial"><b>
	...
	<td align="center" width="75" height="64"><font color="#2B2B2B" size=1 face="Verdana, Arial">
	<?php
	 if ($article->no_buy == 0) {
