...
$res = mssql_query ($select);
	...
	if (mssql_num_rows($res) > 0) {
		...
		echo "<tr>";
		echo "<td bgcolor=\"#FFFF00\" align=\"center\"><font face=\"Verdana\" size=\"1\">" . $frontSection . "</td>";
		echo "<td bgcolor=\"#FFFF00\" align=\"center\"><font face=\"Verdana\" size=\"1\">" . $Antal . " st</td>";
		echo "<td bgcolor=\"#FFFF00\" align=\"center\"><font face=\"Verdana\" size=\"1\"><b><a href=\"front.php?section=" . $frontSection . "\">Visa</a></b></td>";
		echo "</tr>";
