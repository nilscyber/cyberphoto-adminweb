	...
	<div align="center"><center>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
          <tr>
            <td width="50"><font size="1" face="Verdana"><a onMouseOver="return escape('<b>Hintalista</b><br>Hintalista ilman kuvia.')">Hintalista</a></font></td>
            <td width="20">
            ...
            <td width="50"><font size="1" face="Verdana"><a onMouseOver="return escape('<b>Kuvagalleria</b><br>Kuvallinen hintalista.')">Kuvagalleria</a></font></td>
            <td width="20">
		...
		{ %>
            ...
            <td width="25"><font size="1">&nbsp;&nbsp;&nbsp;|</font></td>
            <td width="70"><a onMouseOver="return escape('<b>Varastossa</b><br>Näyttää ainoastaan varastossa olevat puhelimet.')"><font face="Verdana" size="1">Varastossa</font></a></td>
            <td width="20">
		...
		<% } %>
            ...
            <td width="25"><font size="1">&nbsp;&nbsp;&nbsp;|</font></td>
            <td width="100"><a onMouseOver="return escape('<b>Lajittele hinnalla</b><br>Näyttää hintalistaa halvin hinta ensin.')"><font face="Verdana" size="1">Lajittele hinnalla</font></a></td>
            <td width="20">
            <input type="checkbox" name="sortera" onClick="submit()" value="utpris" size="20"<% if ($sortera == "utpris" ) echo " checked";%>>
            </td>
