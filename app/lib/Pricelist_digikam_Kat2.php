...
# version	2000-11-20
	...
	if (count($articles) < 1) {
		$headline = "Tyvärr hittades ingen kamera. Dina önskemål kan inte uppfyllas. Ändra i fälten ovan."; // fast med röd text,, 
	}
	else {
	...
	<?php if (count($articles) < 1) { ?>
		<td bgcolor="#ECECE6" colspan="6"><font color="#85000D" face="Verdana,Arial" size="1"><b>
	<?php } else { ?>
