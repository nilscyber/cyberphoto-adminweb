...
<tr>
	<td colspan="2" valign="top" class="tek_white_row"><a target="_blank" href="/order/admin/Tekn_cameras.php?change=<?php echo $tekniska_data_info; ?>"><img border="0" src="/pic/editera.gif">&nbsp;Editera Tekniska data-tabellen</a></td>
</tr>
<?php } ?>
...
<tr>
	<td valign="top"><?php echo l('Image sensor size'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params1); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Resolution image sensor'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info2($row[$i]->params2); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Resolution image (effective)'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params3); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Compression standard'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
...
<tr>
	<td valign="top"><?php echo l('Brightness optics'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
...
<tr>
	<td valign="top"><?php echo l('Closest focusing distance'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params11); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Memory'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params12); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Memory included'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params13); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Optical viewfinder'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
...
<tr>
	<td valign="top"><?php echo l('Light measurement'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
...
<tr>
	<td valign="top"><?php echo l('Sensitivity to light'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params18); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Shutter speeds'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
...
<tr>
	...
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top" class="tek_first_row"><?php show_tek_digikam($tekniska_artnr[$i], 'NULL'); ?></td>
	<?php endfor; ?>
</tr>
<?php } ?>