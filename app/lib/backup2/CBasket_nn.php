...
function showDeliveryDate($date, $prec, $fi, $sv) {
	...
	if ($date == "" || $date == "1900-01-01") {
		if ($fi && !$sv)
			return "<a onMouseOver=\"return escape('Varan är beställd men leveranstiden är okänd. Vi har inte fått ett leveransbesked från vår leverantör. ')\" style=\"text-decoration: none\"> toimituspäivämäärä ei ole määritelty</a>";
		else 
