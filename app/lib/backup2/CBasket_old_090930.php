...
function add_customer($uppdatera, $mailpassw) {
	...
	if (($pay == "invoiceme" || eregi("avbetalning", $pay) || $this->mobilabonnemang || $pay == "faktura_kampanj" || $pay == "klarnakonto") && isset($_SESSION['CKreditor']->cust_addresses) ) {
...
?>
	...
	if ($_SERVER['REMOTE_ADDR'] == "81.8.240.115" && $firstbasket != 'nooutput' && $pay == "invoiceme") {
	...
	?>
		<tr>
		  ...
		  <?php } ?>
		  <td><font size="1" face="Verdana">&nbsp;</td>
