...
function formatDiscountTxt($rs) {
	...
	if (eregi(".php$", $campaign_link) || eregi(".htm$", $campaign_link) || eregi(".html$", $campaign_link)) {
		...
		$cont = "<a href=\"" . $link . "\"><img border=\"0\" src=\"" . $campaign_link . "\"></a>";
	}
	
	return $cont;
	
}
function getDiscountInfo($artnr, $tillverkar_id=0, $kategori_id=0, $discountCode="") {
