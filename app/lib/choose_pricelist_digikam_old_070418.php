	...
	<div align="center"><center>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
          <tr>
            <td width="50"><a onMouseOver="return escape('<b>Prislista</b><br>Välj denna för prislista utan bilder.')"><font size="1" face="Verdana">Prislista</font></a></td>
            <td width="20">
	...
	<% if ($ArticleIDGroup != "888" && $ArticleIDGroup != "999") { %>
