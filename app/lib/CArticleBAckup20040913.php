...
function createArticleSelect() {
	return("SELECT artnr, beskrivning, kommentar, utpris, tillverkare, link, link_fi, kategori, ej_med, no_buy, motljsk, filterd, skick, garanti, lagersaldo, filmkat_id, release, zoom, ccd ".
