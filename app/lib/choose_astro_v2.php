...
<div class="container_grey floatleft">
  ...
  <table border="0" cellpadding="2" cellspacing="0" width="400">
    <tr>
      <td width="25" align="right"><font face="Verdana" size="1"><input type="checkbox" name="filter1" value="yes" onClick="submit()" <?php if ($filter1 == "yes") echo " checked";?>></font></td>
      ...
      <td width="20"><font face="Verdana" size="1"><input type="checkbox" name="filter2" value="yes" onClick="submit()" <?php if ($filter2 == "yes") echo " checked";?>></font></td>
      <td width="105" align="left">
      ...
      <td width="20"><font face="Verdana" size="1"><input type="checkbox" name="filter3" value="yes" onClick="submit()" <?php if ($filter3 == "yes") echo " checked";?>></font></td>
      <td align="left">
