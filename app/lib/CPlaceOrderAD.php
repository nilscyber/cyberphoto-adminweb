...
function write_toOrderposter($artnr, $newordernr, $count, $includedArticle = false) {
	...
	$discountCode, $discountCodeStatus, $rowDiscount, $freight, $pay, $conn_my, $conn_ms;
	...
	$row = mysqli_fetch_object($res, $conn_my);
	...
	while ($row = mssql_fetch_object($itemres)) :		
		...
		*/
		...
		?>
			...
			<td align="left"><font face="Verdana, Arial" size="1"><?php echo $levDatum; ?></font></td>
