...
?>
	...
	&nbsp;&nbsp;
		...
		<td bgcolor="#ECECE6" colspan="<% if ($sortera == "zoom" || $sortera == "ccd") echo 6; else echo 5;%>"><font color="#2B2B2B"  face="Verdana,Arial"><small><small><b>
        <%
               if ($article->kategori <> ".") {
                        if ($headline) {
                             print "$headline";
	...
	$bilden = $article->artnr . ".gif";
	$bildlänk = "/home/www/tumnagel/" . $bilden;
	if (file_exists($bildlänk)): 
	...
	%>
	<img src="/tumnagel/<% echo $bilden; %>" border="0">	
	</A>
	<% 
