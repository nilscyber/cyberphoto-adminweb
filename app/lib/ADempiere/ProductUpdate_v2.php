...
class ProductUpdate {
	 ...
	 * Link to web service
	 */
	public static $wsdlLink = "http://erp-services.cyberphoto.local:8080/adempiere-adempiereWs/ProductUpdateWs?wsdl";
	...
	function setIsExclAutoPricing($isExclAutoPricing) {
		$this->isExclAutoPricing = $isExclAutoPricing ? 'Y' : 'N';
	}
	/**
