...
<tr>
	<td colspan="2" valign="top" class="tek_white_row"><a target="_blank" href="/order/admin/Tekn_lenses.php?change=<?php echo $tekniska_data_info; ?>"><img border="0" src="/pic/editera.gif">&nbsp;Editera Tekniska data-tabellen</a></td>
</tr>
<?php } ?>
...
<tr>
	<td valign="top"><?php echo l('Type of lens'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params1); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Lens mount'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params2); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Construction'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params3); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Focal length'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params4); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Brightness'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top"><?php show_info($row[$i]->params5); ?></td>
	<?php endfor; ?>
</tr>
<tr>
	<td valign="top"><?php echo l('Minimum aperture'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
...
<tr>
	<td valign="top"><?php echo l('Magnification ratio'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
...
<tr>
	<td valign="top"><?php echo l('Lens hood'); ?></td>
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
...
<tr>
	...
	<?php for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '2') break;  ?>
	<td valign="top" class="tek_first_row"><?php show_tek_objektiv($tekniska_artnr[$i], 'NULL'); ?></td>
	<?php endfor; ?>
</tr>
<?php } ?>