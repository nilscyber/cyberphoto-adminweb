	    <% If ($_SESSION['RememberPageView'] == 1 && $prislistan == "" ) {
	    	...
	    	If ($_SESSION['RememberMoms'] == "" || $showmoms == "" ) {
	    	$_SESSION['RememberMoms'] = 0;
	    	}
	    	elseif ($_SESSION['RememberMoms'] == 0 && $showmoms == "") {
	...
	<div align="center"><center>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
          <tr>
            ...
            <td width="25"><font size="1">&nbsp;&nbsp;&nbsp;|</font></td>
            <td width="100"><a onMouseOver="return escape('<b>Med eller utan moms</b><br>Välj här om du vill visa prislistan med eller utan moms.')"><font face="Verdana" size="1">Priser med moms</font></a></td>
            <td width="20">
            <input type="checkbox" name="showmoms" onClick="submit()" value="25" size="20"<% if ($_SESSION['RememberMoms'] == 0 ) echo " checked";%>>
            </td>
