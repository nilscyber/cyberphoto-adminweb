...
Class CSvea {
    ...
    function create_rows() {
        ...
        $moms, $moms1, $moms2, $moms3, $moms4, $goodsvalue, $fi, $sv, $pay, $goodsvalueMoms, $extra_frakt, $butiksfrakt, $old_foretag;
    ...
    function reserve_amount() {
        ...
        if ($this->kreditor_status != 0) {
			...
			if ($this->pclass == 213061) { // s�tt pclass f�r att maila ut till ber�rd
