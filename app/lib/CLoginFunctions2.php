...
function check_lager2($artnr, $lagersaldo, $bestallt, $lev_datum, $lev_datum_normal, $bestallningsgrans, $fi, $release) {
		global $count, $lagersaldo, $bestallt, $lev_datum, $lev_datum_normal, $bestallningsgrans, $release;
		$count = 1;
...
function check_lager($artnr, $fi = false) {
	global $count, $lagersaldo, $bestallt, $lev_datum, $lev_datum_normal, $package_stock, $bestallningsgrans, $queue, $est_delivery, $release;
	$lager = "";
				...
				elseif ($bestallningsgrans == '0') 
					{  
						...
						if ($fi == 'yes')
							...
							$lager .= "<font size=\"1\" face=\"Verdana, Arial\" color=\"#85000D\">beställningsvara, normal leveranstid $lev_datum_normal";
					}
				else
					{ 
						if ($fi == 'yes')
							...
							$lager .= "<font size=\"1\" face=\"Verdana, Arial\" color=\"#85000D\">tillfälligt slut, normal leveranstid $lev_datum_normal" ;
					}
				}
		}         
	}
