...
function createArticleSelect() {
	return("SELECT artnr, Artiklar.beskrivning, Artiklar_fi.beskrivning_fi, Artiklar.kommentar, Artiklar_fi.kommentar_fi, utpris_fi, utpris, bild, tillverkare, link, Artiklar_fi.link2_fi, " . 
		"kategori, kategori_fi, ej_med_fi as ej_med, no_buy, motljsk, filterd, skick, garanti, lagersaldo_fi, lagersaldo, filmkat_id, releaseDate as rel, zoom, ccd, betyg, " . 
		"zoom_digikam, Moms.momssats_fi as momssats, bestallningsgrans_fi, bestallningsgrans, utgangen, utgangen_fi, Artiklar_fi.demo_fi ".
