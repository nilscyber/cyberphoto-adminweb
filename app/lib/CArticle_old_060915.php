...
function createArticleSelect() {
	return("SELECT artnr, Artiklar.beskrivning, Artiklar.kommentar, utpris, tillverkare, link, link_fi, kategori, ej_med, no_buy, motljsk, filterd, skick, garanti, lagersaldo, filmkat_id, release, zoom, ccd, betyg, zoom_digikam, Moms.momssats, bestallningsgrans ".
