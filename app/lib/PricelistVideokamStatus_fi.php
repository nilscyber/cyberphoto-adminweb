...
$sv = false;
	...
	%>
		...
		<tr>
		<td colspan="<% if ($sortera == "zoom" || $sortera == "ccd") echo 5; else echo 4;%>"><font color="#2B2B2B"  face="Verdana,Arial"  size="1"><b>
        <%
	...
	if ($sortera == "testres") {
			if ($article->betyg != $current_betyg) {
				...
				$sel = "SELECT betygBeskrivning_fi FROM Betyg WHERE betygId = " . $article->betyg;
		...
		<tr>
		<td bgcolor="#ECECE6" colspan="5"><font color="#003E87" face="Verdana,Arial" size="1"><b>
		<% echo $row->betygBeskrivning_fi; %>
