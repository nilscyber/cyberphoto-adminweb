...
$select = "SELECT Artiklar.artnr, Artiklar.beskrivning, kommentar, utpris, tillverkare, no_buy, link, ";
...
<% } else { 
	...
	if (sendMail($row, $senderMail, $receiverMail, $messageHtml, "", $conn_mssql, $artnr)) { 
	//exit;
	%>
...
function sendMail($row, $from, $to, $messageHtml, $messageText, $conn_mssql, $artnr) {
