...
<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	...
	<% $artnr = $tekniska_artnr[$i]; include ("/home/www/cgi-bin/buyspot_tekn_new_fi_se.php"); %>
	</font></a></td>
<% endfor; %>
</tr>
...
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->system); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
...
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->ccdBrutto); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->cccdNettoFilm); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->ccdNettoStillbild); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->stillbildslage); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->objektiv); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->zoom); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->digitalZoom); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->bildstabilisering); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->minstaBelysning); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->manuellFokus); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->filterdiam); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->vitbalans); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->digitalaEffekter); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->wide); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->exponering); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->motivprogram); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->sokare); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->fargLcd); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->blixt); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->minneskort); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"> Minneskapacitet</font></a></td>
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->minneskapacitet); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->hogtalare); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->RCAut); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->RCAin); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->svideoUt); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->svideoIn); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->dvUt); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->dvIn); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->micIn); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->usb); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->horlursutgang); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->fjarrkontroll); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
...
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->vikt); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->bruksanvisning); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->medfoljandeTillbehor); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->medfoljandeProgramvara); %></font></a></td>
	<% endfor; %>
</tr>
<tr>
	...
	<% for ($i = 1; $i <= $num_of_articles; $i++): if ($i > '3') break;  %>
	<td valign="top" bgcolor="#ECECE6"><font face="Verdana, Arial" size="1"><% show_info($row[$i]->edit); %></font></a></td>
	<% endfor; %>
</tr>
