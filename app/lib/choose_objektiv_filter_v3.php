...
<div class="content">
	...
	<table border="0" cellpadding="2" cellspacing="0" width="100%">
	  ...
	  <tr>
		<td width="25"><input type="checkbox" name="bildstab" value="yes" onClick="submit()"<?php if ($MF != 3 && $MF != 7 && $MF != 13 && $MF != 777) echo " disabled";?><?php if ($bildstab == "yes") echo " checked";?>></td>
		<td>
