...
?>
	...
	<table border="0" cellpadding="3" cellspacing="0" style="border-left: 1px solid #EEEEEE; border-right: 1px solid #CFCFCF; border-top: 1px solid #EEEEEE; border-bottom: 1px solid #CFCFCF" width="100%">
	<tr>
	<td align="left" width="150" height="100"><font color="#2B2B2B" size=1 face="Verdana, Arial">
	<?php
	...
	<td width="450" height="100"><font color="#2B2B2B" size="1" face="Verdana"><b>
	<?php
	print "<A style=\"text-decoration: none\" HREF=\"info.php?article=".$article->artnr."\">";
	...
	<td align="center" width="100" height="100"><font color="#000000" size=2 face="Verdana, Arial"><b>
	...
	<td align="center" width="100" height="100"><font color="#2B2B2B" size=1 face="Verdana, Arial">
	<?php
	 if ($article->no_buy == 0) {
