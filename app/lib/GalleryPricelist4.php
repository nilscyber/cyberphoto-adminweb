...
?>
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td height="3"><font face="Verdana" size="1"><img src="10.gif" width="1" height="1"></font></td>
	  </tr>
	  <tr>
	    <td bgcolor="#000000" width="100%" height="1"><font face="Verdana" size="1"><img src="10.gif" width="1" height="1"></font></td>
	  </tr>
	  <tr>
	    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
	      <tr>
	        <td><img src="vertline_gallery.gif" width="4" height="15"><font color="#2B2B2B"  face="Verdana" size="2"><b>
	...
	<%
	 if ($article->no_buy == 0) {
	 	if ($article->lagersaldo > 0) {
			...
			print "<IMG ALT=\"Varan finns i vårt lager\" SRC=\"/ralph/kopknappar/gron_1.gif\" border=0>";
			print "</A>";
			}
		elseif ($article->lagersaldo == 0 && $article->bestallningsgrans > 0) {
			print "<A HREF=\"javascript:modifyItems('$article->artnr')\">";
			print "<IMG ALT=\"Varan är beställd\" SRC=\"/ralph/kopknappar/orange_1.gif\" border=0>";
			print "</A>";
			}
		elseif ($article->lagersaldo == 0 && $article->bestallningsgrans == 0) {
			print "<A HREF=\"javascript:modifyItems('$article->artnr')\">";
			print "<IMG ALT=\"Beställningsvara\" SRC=\"/ralph/kopknappar/bla_1.gif\" border=0>";
			print "</A>";
			}
	}
	else
