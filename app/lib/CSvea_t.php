...
Class CSvea {
    ...
    function reserve_amount() {
        ...
        $request = Array(
            "Auth" => Array(
                "Username" => '0,73', //$this->sveaUserName,
                "Password" => $this->sveaPassword,
                "ClientNumber" => $this->sveaAccountNo
            ),
        ...
        try {
            $client = new SoapClient($this->wsdlLin);
            ...
            //echo $errMess;
            //exit;
            Log::createTicketAndLog($errMess, "Krasch när kund försöker skapa svea betalning", null, $_SESSION['currentLocale'], Log::LEVEL_ALERT, null);
        }
