...
<div class="content">
  ...
  <table border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr>
      ...
      <?php if ($sv) { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/film.php"); ?>')">
      <?php } else { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/film_fi.php"); ?>')">
      <?php } ?>
      ...
      <td width="20"><font face="Verdana" size="1"><input type="checkbox" name="filter10" value="yes" onClick="submit()"<?php if ($filter10 == "yes") echo " checked";?>></font></td>
      <td align="left">
      <?php if ($sv) { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/lcd.php"); ?>')">
      <?php } else { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/lcd_fi.php"); ?>')">
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter10 == "yes") { ?><b><font color="#85000D"><?php } ?><?php if ($sv): ?>Vikbar LCD-skärm<?php else: ?>Kääntyvä näyttö<?php endif; ?></font></b></td>
    </tr>
    <tr>
      ...
      <td width="148" align="left">
      <?php if ($sv) { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/liveview.php"); ?>')">
      <?php } else { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/liveview_fi.php"); ?>')">
      <?php } ?>
      ...
      <td width="148" align="left">
      <?php if ($sv) { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/fullformat.php"); ?>')">
      <?php } else { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/fullformat_fi.php"); ?>')">
      <?php } ?>
      ...
      <td width="20"><font face="Verdana" size="1"><input type="checkbox" name="filter11" value="yes" onClick="submit()"<?php if ($filter11 == "yes") echo " checked";?>></font></td>
      <td align="left">
      <?php if ($sv) { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/spegelfri.php"); ?>')">
      <?php } else { ?>
      <a onMouseOver="return escape('<?php include ("explanation/systemkam/spegelfri_fi.php"); ?>')">
      <?php } ?>
      <font face="Verdana" size="1"><?php if ($filter11 == "yes") { ?><b><font color="#85000D"><?php } ?><?php if ($sv): ?>Spegelfri<?php else: ?>Peilitön<?php endif; ?></font></b></td>
    </tr>
    </table>
  ...
  <table border="0" cellpadding="2" cellspacing="0" width="100%">
	...
	<select name="marke" onchange="this.form.submit(this.options[this.selectedIndex].value)" size="1" <?php if ($marke > "0"): echo 'style="color: #85000D; font-weight: bold; font-family: Verdana; font-size: 10px"'; else: echo 'style="color: #000000; font-weight: normal; font-family: Verdana; font-size: 10px"'; endif;?>>
		...
		<option value="5"<?php if ($marke == "5") echo " selected";?>>Leica</option>
