	...
	<?php } ?>
		<table border="0" cellpadding="5" cellspacing="0" style="border: 1px solid #999999; background-color: #C4E1FF">
		  ...
		  <tr>
			<td align="left">Varav köp: <b><font color="#FF0000">*</font></b></td>
			<td><input type="text" name="addNumberBuy" size="60" value="<?php echo $addNumberBuy; ?>" style="font-family: Verdana; font-size: 8pt"></td>
		  </tr>
		  <tr>
