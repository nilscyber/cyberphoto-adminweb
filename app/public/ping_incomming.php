...
if ($subm) {
	...
	if ($olright) {
		$tradein->addKoNumber($konumber,null);
		$uppdate_ok = true;
	}
...
echo "\t\t$('#kosystem_nr').load('incl_ping.php');\n";
echo "\t}\n";
...
<?php
	...
	echo "<a href=\"javascript:winPopupCenter(190, 350, '/ping_update.php?edit=yes');\">\n";
	echo "<div ID=\"kosystem_nr\">" . $tradein->getLastPing() . "</div>\n";
	echo "</a>\n";
