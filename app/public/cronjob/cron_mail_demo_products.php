<?php
// /cronjob/cron_mail_demo_products.php
// Skickar sammanfattning av fyndprodukter aldre an 90 dagar.
...
$recipientsBCC = array('karoline.juliusson@cyberphoto.se','service@cyberphoto.se');
$bcc           = implode(', ', $recipientsBCC);

$rows = $tool->getOldProducts('demo', 90);
...
$dtStr       = date('Y-m-d');
$subjectText = "Fyndprodukter att \xc3\xa5tg\xc3\xa4rda - {$total} st ({$dtStr})";
$subject     = '=?UTF-8?B?' . base64_encode($subjectText) . '?=';

$html  = '<!doctype html><html><head><meta charset="UTF-8"></head>';
$html .= '<body style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#111;">';
$html .= '<p>Fyndprodukter/demoprodukter med lager &gt; 0 vars s&auml;ljstart passerades f&ouml;r mer &auml;n <strong>90 dagar</strong> sedan.</p>';
...
$html .= '</tr>';
$html .= '</table>';
$html .= '<p style="margin-top:12px;"><a href="https://admin.cyberphoto.se/demo_products.php">Visa i admin</a></p>';
$html .= '</body></html>';

$boundary = '=_CP_DEMO_' . md5(uniqid((string)mt_rand(), true));
$headers   = array();
