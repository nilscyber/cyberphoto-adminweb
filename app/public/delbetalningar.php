<?php
require_once ("CAvbetalningar.php");
$avbet = new CAvbetalningar();
?>
<html>
...
<table border="0" cellpadding="5" cellspacing="0" height="100%" width="100%">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
      <tr>
        <td width="100%"><b><font face="Arial">Avbetalningar</font></b></td>
      </tr>
      <tr>
        <td width="100%"><font face="Verdana" size="1">&nbsp;</font></td>
      </tr>
      <tr>
        <td width="100%"><?php $avbet->getPayment('SEK'); ?></td>
      </tr>
      <tr>
        <td width="100%"><font face="Verdana" size="1">&nbsp;</font></td>
      </tr>
      <tr>
        <td width="100%"><?php $avbet->getPayment('EUR'); ?></td>
      </tr>
      <tr>
        <td width="100%"><font face="Verdana" size="1">&nbsp;</font></td>
      </tr>
