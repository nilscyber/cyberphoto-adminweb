<?php
// ============================================================
// demo_products_v1.php
// Sida: Fyndprodukter äldre än 90 dagar
// Visar demo-/fyndprodukter (demo_product='Y', istradein='N') som:
...
$rows = $tool->getOldProducts('demo', $maxDays);
...
<div style="padding: 16px;">
    ...
    <h1>Fyndprodukter äldre än 90 dagar och som måste åtgärdas</h1>
    ...
    <?php if ($total === 0): ?>
        ...
        <div class="no-results">
            Inga fyndprodukter äldre än 90 dagar hittades  bra jobbat! ??
        </div>
