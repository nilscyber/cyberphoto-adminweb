<?php
	...
	$mcFileManagerConfig['filesystem.path'] = '/home/www'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = '/home/www'; // absolute or relative from this script path.
