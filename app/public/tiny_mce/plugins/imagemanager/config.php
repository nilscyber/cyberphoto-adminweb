<?php
	...
	$mcImageManagerConfig['filesystem.path'] = '/home/www'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '/home/www'; // absolute or relative from this script path, required.
